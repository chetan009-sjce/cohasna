...
<form  action="" method="POST">
    ...
    <div class="form-group col-md-6">
        <label for="requester_add1"class="font-weight-bold pl-2">Address Home</label>
    ...
    <div class="form-group col-md-6">
        <label for="requester_add2"class="font-weight-bold pl-2">Address Hospital</label>
    ...
    <div class="form-row">
    <div class="form-group col-md-6">
        <label for="assign_tech"class="font-weight-bold pl-2">Assign Ward</label>
        <input type="text" class="form-control" id="assign_tech"  name="assign_tech" readonly>
    </div>
