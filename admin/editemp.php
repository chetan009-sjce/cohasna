...
?>
<div class="col-sm-6 mt-5 mx-3 jumbotron"><h3 class="text-center">Update Ward Details</h3>
<?php  $_REQUEST['id'];?>
<?php 
...
<a href="wards.php" class="btn btn-secondary">Close</a>
</div>
