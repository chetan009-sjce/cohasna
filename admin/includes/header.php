            ...
            <div class="row">
                <nav class="col-sm-2 bg-dark sidebar py-5 d-print-none"><!..sidebar 1st column>
                    <div class="sidebar-sticky"><ul class="nav flex-column">
                        ...
                        <li class="nav-item"> <a class="nav-link  <?php if(PAGE=='submitrequest1'){echo 'active';} ?>" href="submitrequest1.php"><i class="fab fa-accessible-icon"></i> submit Request</a></li>
