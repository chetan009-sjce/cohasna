...
if(isset($_REQUEST['submitrequest'])){
    ...
    $_REQUEST['requesterdate']==""){
       ...
       if($conn->query($sql)==TRUE){
        ...
        $_SESSION['myid']=$genid;  
        $regmsg= '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert">submitted</div>';
...
<form class="mx-5" action="" method="POST">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="inputRequestInfo" placeholder="Required Blood-plasma type" name="requestinfo">
    </div>
    <div class="form-group">
        <label for="inputRequestInfo"class="font-weight-bold pl-2">Description</label>
        <input type="text" class="form-control" id="inputRequestDescription>" placeholder="Age,Blood-group" name="requesdesc">
    </div>
    <div class="form-group">
    ...
    <div class="form-group col-md-6">
        <label for="inputAddress"class="font-weight-bold pl-2">Address Home</label>
        <input type="text" class="form-control" id="inputAddress" placeholder="House No. 123" name="requesteradd1">
    </div>

    <div class="form-group col-md-6">
        <label for="inputAddress"class="font-weight-bold pl-2">Address Hospital</label>
