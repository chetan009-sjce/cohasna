...
<div class="col-sm-4 mt-5">
        <div class="card text-white bg-success mb-3" style="max-width:22rem">
            <div class="card-header">completed Work</div>
            <div class="card-body">
            <h4 class="card-title"><?php echo $assignwork;?></h4>
            <a class="btn text-white"href="viewassign.php">View</a>
        </div>
        </div>
</div>
<!-- <div class="col-sm-4 mt-5">
        <div class="card text-white bg-info mb-3" style="max-width:18rem">
            <div class="card-header">No Of Wards</div>
            <div class="card-body">
...
<div class="mx-5 mt-5 text-center">
    <p class="bg-dark text-white">List Of Requests</p>
    <?php 
